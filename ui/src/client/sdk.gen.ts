 ...
 */
export const getCrawlerSites = <ThrowOnError extends boolean = false>(options?: Options<GetCrawlerSitesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetCrawlerSitesResponses, unknown, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                name: 'X-API-KEY',
